  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="relative h-px flex-1 bg-niebla" aria-hidden>
        <div
          className="absolute inset-y-0 left-0 bg-piedra transition-[width] duration-300"
          style={{ width: `${pct}%` }}
        />
        <div
          className="absolute top-1/2 h-2 w-2 -translate-y-1/2 rounded-full bg-piedra transition-[left] duration-300"
