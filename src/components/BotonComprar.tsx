...
export function BotonComprar({
  ...
  return (
    <a
      ...
      className="flex min-h-[52px] w-full items-center justify-center rounded-xl bg-vitamina px-5 font-body text-lg font-medium text-porcelana transition-transform active:scale-[0.98]"
    >
      {label}
    </a>
  );
